...
def spin_payout(reel_1, reel_2, reel_3):
    if (reel_1 == LIBERTY_BELL and reel_2 == LIBERTY_BELL and reel_3 == LIBERTY_BELL):
        ...
        return 10
    elif (reel_1 == HORSESHOE and reel_2 == HORSESHOE and reel_3 != 4):
        return 5
    elif (reel_1 == HORSESHOE and reel_2 != 4 and reel_3 == HORSESHOE):
        return 5
    elif (reel_1 != 4 and reel_2 == HORSESHOE and reel_3 == HORSESHOE):
        return 5
    else:
        return 0
...
def simulate(how_many):
    ...
    for i in range(how_many):
        ...
        reel_2 = random.randint(1, 5)
        reel_3 = random.randint(1, 5)
        total_earnings += spin_payout(reel_1, reel_2, reel_3)
        profit = total_earnings/(how_many*5)
    print("For every $1 spent, you can expect to win {:0.2}".format(profit))
# --------------------------------------
